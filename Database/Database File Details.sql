...
DB File Overview
By Sean Huff, 2013/03/21
5 stars
shows filenames, locations, sizes, free space, growth rate
can be run from any database
http://www.sqlservercentral.com/scripts/Database+File/97344/
***************************************************************************************************
*/
...
insert into @tmp
(DBName,[FileName],FileLoc,FileType,SizeInMB,FreeSpaceInMB,GrowthRate,MaxSize,CurrentState)
...
cast(isnull(FreeSpaceInMB,0) as varchar(256)) as FreeSpaceInMB,GrowthRate,MaxSize,NumOfVLF,CurrentState
from @tmp
