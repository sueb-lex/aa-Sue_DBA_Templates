...
http://sqlmag.com/database-administration/quickly-identify-database-and-file-sizing-any-sql-server-instance?NL=TECH-007a&Issue=TECH-007a_20170316_TECH-007a_882&sfvc4enews=42&cl=article_3_b&utm_rid=CPMIN000008536736&utm_campaign=83615&utm_medium=email&elq2=5e280e12739a4b49b102a6b7aaf8b286

EXEC dbo.sp_sizing; -- file level granualarity and return results for all databases (default)
EXEC dbo.sp_sizing 'd', NULL; -- database level granualarity and return results for all databases
EXEC dbo.sp_sizing 'd', 'master'; -- database level granualarity and return results a single database
EXEC dbo.sp_sizing NULL', 'master'; -- file level granualarity and return results a single database
-------------------------------------------------------------*/
