--Determine Last Time a Table Was Accessed
--select database you want to look at and then run this script 
...
--http://www.sqlservercentral.com/scripts/Accessed+Date/94219/
