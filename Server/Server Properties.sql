...
-- http://dl.dropbox.com/u/13748067/SQL%20Server%202005%20Diagnostic%20Information%20Queries(May%202012).sql (location of this info)
-- windows version [SELECT OSVersion =RIGHT(@@version, LEN(@@version)- 3 -charindex (' ON ',@@VERSION))]
